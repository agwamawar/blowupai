      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupContent>
            ...
            >
              <div className="flex items-center justify-center bg-gradient-to-br from-[#9c5c64] to-black/20 rounded-full h-6 w-6 mr-2 transition-transform duration-200 hover:scale-110">
